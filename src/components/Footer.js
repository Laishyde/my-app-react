...
const Footer = () => {
  ...
  return (
    <div className='time'>
       <h1 id='Contato' className='text pp'>Contato</h1>
  <div className='test'>
...
<div className='object'>
       <img className='globo' src={Gif} alt="" />
       </div>
    
  </div>           
    <div>
      <footer>
        <h3>Laís Cristina 2023</h3>
        <p className='final'>laiscristina.animamundi@gmail.com</p>
      
     
        <a href="#Voltar"> <p  className='voltar'>voltar</p></a>
